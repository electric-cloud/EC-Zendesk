    ...
    extends ListBase
{
    ...
    {
        super("ecgc", "EC-Zendesk Configurations", "All Configurations");
    ...
    private void deleteConfiguration(String configName)
    {
        ...
        request.setProjectName("/plugins/EC-Zendesk/project");
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the EC-Zendesk configuration '"
                            + configName + "'?") {
